...
/**
 * Created by dankindler on 3/26/17.
 */

public class ContactHandler {

    Context context;
    static ContactHandler shared = new ContactHandler();

    public void addContact(String displayName, String number, Context cntx)
    {
        ...
        try
        {
            ...
            Log.d("saving contact", "trying to save");
        ...
        {
            Log.d("saving contact", exp.toString());
            //logs;
        }
